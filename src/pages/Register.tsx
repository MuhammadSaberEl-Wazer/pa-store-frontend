        ...
        <div className="lg:grid  lg:min-h-[80vh] lg:grid-cols-12">
          ...
          <main className="flex items-center justify-center  px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div  className="w-full h-full flex justify-center flex-col items-center">
              <form action="#" className="mt-8 w-full md:w-[80%] mx-auto gap-6">
                <div className="col-span-12 ">
                  <label htmlFor="FirstName" className="block text-lg font-medium text-primary-text">
                    الاسم الأول
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-span-12 ">
                  <label htmlFor="LastName" className="block text-lg font-medium text-primary-text">
                    الاسم الأخير
                  </label>
                  <input
                    type="text"
              ...
              <p className="mt-4 text-center text-lg text-gray-500">
                لديك حساب بالفعل؟
                <Link to={'/login'} className="font-medium text-primary-text mx-[5px] hover:underline" >
                  تسجيل الدخول
                </Link>
              </p>
            </div>
