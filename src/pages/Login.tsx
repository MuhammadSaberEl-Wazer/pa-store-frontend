            ...
            <div className="max-w-xl lg:max-w-3xl">
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                <div className="col-span-6">
                  <label htmlFor="Email" className="block text-lg font-medium text-primary-text">البريد الإلكتروني</label>
                  <input
                    type="email"
                    id="Email"
                    name="email"
                ...
                <div className="col-span-6">
                  <label htmlFor="Password" className="block text-lg font-medium text-primary-text">كلمة المرور</label>
                  <input
                    type="password"
                    id="Password"
                    name="password"
                ...
                <div className="col-span-6">
                  <p className="text-lg text-gray-500">
                    ...
                    <a href="#" className="text-gray-700 underline">الشروط والأحكام</a> و{" "}
                    <a href="#" className="text-gray-700 underline">سياسة الخصوصية</a>.
                  </p>
                </div>

                <div className="col-span-6 flex justify-between">
                  
                  <a href="#" className="text-lg text-gray-500 hover:underline">هل نسيت كلمة المرور؟</a>
                </div>
                <div className="col-span-6">
                <button
                    type="submit"
                    className="inline-block w-full col-span-6 rounded-md bg-primary-text px-8 py-3 text-lg font-medium text-white hover:bg-red-950 focus:outline-none focus:ring focus:ring-gray-300"
                  >
                    تسجيل الدخول
                  </button>
                </div>
                ...
                <div className="col-span-6 mt-6">
                  <p className="text-lg text-gray-500">
                    ليس لديك حساب؟
                    <Link to="/register" className="text-gray-700 underline"> سجل الآن</Link>
                  </p>
                </div>
              </form>
            </div>
